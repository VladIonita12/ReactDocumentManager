...
class AddCompanyClient extends Component{
    constructor(props) { 
        super(props);
     ...
     this.state = {
      ...
      this.store = new CompanyClientStore();
    ...
    this.saveInfo = () =>{
      ...
      this.store.addCompanyClient(this.props.idCompany,this.props.idDepartment,this.props.contractId,{
     ...
     return(
        ...
        <div class="container">
          ...
          <form onSubmit={this.handleSubmit} >
            ...
            <input type="text" name="clientStreetNumber" class="form-control" id="clientStreetNumber" onChange={this.handleChange} value={this.state.clientStreetNumber} />
